function ImgUpload(config) {
     ...
     */
    this.fileId = config.fileId || 'file';

    /**
     * tip for error message.
     * @type {string}
     */
    this.tip = config.tip || '请上传格式为png, gif或者jpg的图片';
    /**
     * The ID for the container which contains img tags.
     * @type {string}
     */
    this.containerId = config.containerId || 'container';
    /**
     * CSS style for previewing imgs.
     * @type {string}
     */
    this.imgStyle = config.imgStyle || 'width:100%;height:auto;';
